...
setenv("%if", {_stash: true, special: function (cond, cons, alt) {
  ...
  indent_level = indent_level + 1;
  var _x109 = compile(cons, {_stash: true, stmt: true});
  indent_level = indent_level - 1;
  var _cons1 = _x109;
  var _e36;
  if (alt) {
    indent_level = indent_level + 1;
    var _x110 = compile(alt, {_stash: true, stmt: true});
    indent_level = indent_level - 1;
    _e36 = _x110;
  }
  var _alt1 = _e36;
...
setenv("while", {_stash: true, special: function (cond, form) {
  ...
  indent_level = indent_level + 1;
  var _x112 = compile(form, {_stash: true, stmt: true});
  indent_level = indent_level - 1;
  var body = _x112;
  var ind = indentation();
  if (target === "js") {
...
setenv("%try", {_stash: true, special: function (form) {
  ...
  indent_level = indent_level + 1;
  var _x124 = compile(hf, {_stash: true, stmt: true});
  indent_level = indent_level - 1;
  var h = _x124;
  return(ind + "try {\n" + body + ind + "}\n" + ind + "catch (" + e + ") {\n" + h + ind + "}\n");
}, stmt: true, tr: true});
