...
pr = function () {
  var _r43 = unstash(Array.prototype.slice.call(arguments, 0));
  var _id18 = _r43;
  var sep = _id18.sep;
  var l = cut(_id18, 0);
  var c = undefined;
...
git = function (path, what) {
  ...
  var _x26 = ["git", "--git-dir=" + q(j(path, ".git")), what];
  _x26.hush = true;
  return(apply(_36, join(_x26, args)));
};
